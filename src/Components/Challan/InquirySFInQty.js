...
const InquirySFInQty = ({ balanceDetails, onPlannedChange }) => {
    return (
        <Grid2 container>
            <Grid2 xs={12} className="d-none d-sm-block">
                <Typography
                    ...
                    <Grid2
                        ...
                        <Grid2 md>Ready To Inword</Grid2>
                        <Grid2 md>Inword</Grid2>
                    </Grid2>
                </Typography>
            </Grid2>
            ...
            <Grid2 xs={12} >
                <Typography component={"span"} fontSize={commonFontSize}>
                    {
                        balanceDetails.filter((product) => product.atVendor > 0)
                            .map((product, index) => {
                                return (
                                    ...
                                    <Grid2
                                        ...
                                        <Grid2 xs={12} md>
                                            {checkValueNumber(product.atVendor)}
                                        </Grid2>
